...
//        }
    ...
    public void OpenBrowser(String url) throws MalformedURLException {
        setUpBrowser(false,"browserStack","windows","10","chrome","89",url);
    ...
    public void clickOnElementUsingWebElement(WebElement element) {
        element.click();
    }
    ...
    /**
     * This method is for some situation where need to pass the driver
     *
     * @param locator
     * @param driver1
     * @return
    ...
    /**
     * This method is converting List type of WebElements to List type of Stings
     *
     * @param list
     * @return
     */
